...
function Router(props) {
  const role = props.auth.role ? parseInt(props.auth.role) : 0; // 1 = admin, 0 = user, 2= authorities
      ...
      <BrowserRouter>
        ...
        (
          ...
          <AuthoritiesLayout>
            <Routes>
              <Route path="/" element={<h1>หลังบ้าน</h1>} />
              <Route path="/authorities/book-an-appointment" element={<h1>จองคิว</h1>} />
              <Route path="/authorities/open-schedule" element={<MainOpenSchedule />} />
              <Route path="/authorities/open-schedule/form" element={<FormOpenSchedule />} />
              <Route path="/authorities/treatment-type" element={<MainTreatmentType />} />
              <Route path="/authorities/doctor" element={<MainDoctor />} />
              <Route path="/authorities/doctor/form" element={<FormDoctor />} />
              <Route path="/authorities/user" element={<MainUser />} />
              <Route path="/authorities/user/form" element={<FormUser />} />
              <Route path="*" element={<Redirect/>} />
            </Routes>
          </AuthoritiesLayout>
        ) 
